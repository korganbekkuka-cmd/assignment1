[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/sjZ_geAF)
# oop-assignment-01
...
+ Hints:
  ...
  + the magnitude of the cross product of two vectors is _two times the area of the triangle between the vectors_
...
1. **Unknown** is a hidden treasure that does not want to show up.
2. **Novice** is able to declare, create and initialize objects with constructors, invoke various methods like getters and setter and others.
4. **Intermediate** is able to declare and create an array of objects and populate it with real objects, and manipulate the objects in the array.
5. **Proficient** is able to implement the class with constructors and getters and setters, and various methods.
6. **Expert** is able to implement and discuss all the methods including the ones heavy on algorithms and math.
